...
```
cd existing_repo
git remote add origin https://gitlab.com/Nikolay-Yakunin/blog-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Nikolay-Yakunin/blog-service/-/settings/integrations)
